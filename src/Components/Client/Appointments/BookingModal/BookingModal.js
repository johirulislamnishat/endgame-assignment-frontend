...
const BookingModal = ({ date, open, handleClose, appointment }) => {
  const { img, name, department, fees, chamber, phone, designation } =
    appointment;
  ...
  return (
    <>
      ...
      >
        <Box sx={style}>
          ...
          <form
            ...
            style={{ height: "350px", overflowY: "scroll", padding: 10 }}
          >
            <TextField
              disabled
            ...
            <input
              className="form-btn btn-secondary my-2"
              type="submit"
              value="Submit"
            />
          </form>
      ...
      <Sneackbar
        openSneackBar={openSneackBar}
        setOpenSneackBar={setOpenSneackBar}
      />
    </>
  );
};
