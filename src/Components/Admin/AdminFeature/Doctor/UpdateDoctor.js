...
const UpdateDoctor = () => {
  ...
  const onSubmit = (data) => {
    axios
      .post("http://localhost:7000/doctors", data)
      .then((res) => {
        // console.log(res);
            ...
            <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
              ...
              <div className="mt-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <button
                    type="submit"
                    className="py-2 px-4  btn-dash hover:bg-blue-400 focus:ring-purple-500 focus:ring-offset-purple-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
                  >
                    Add Engineer
                  </button>
                </form>
